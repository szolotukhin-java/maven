...
import static org.eclipse.aether.connector.basic.PartialFile.*;
...
final class BasicRepositoryConnector
    ...
    private static final String CONFIG_PROP_THREADS = "aether.connector.org.eclipse.aether.connector.basic.threads";
    ...
    private final Factory partialFileFactory;
    ...
    BasicRepositoryConnector(RepositorySystemSession session, RemoteRepository repository,
        ...
        partialFileFactory = new Factory(resumeDownloads, resumeThreshold, requestTimeout);
    }
    ...
    public void get(Collection<? extends ArtifactDownload> artifactDownloads,
        ...
        for (MetadataDownload transfer : safe(metadataDownloads)) {
            ...
            org.eclipse.aether.connector.basic.MetadataTransportListener listener = new org.eclipse.aether.connector.basic.MetadataTransportListener(transfer, repository, builder);
    ...
    abstract class TaskRunner
        ...
        TaskRunner(URI path, org.eclipse.aether.connector.basic.TransferTransportListener<?> listener) {
            this.path = path;
    ...
    class PeekTaskRunner
        ...
        PeekTaskRunner(URI path, org.eclipse.aether.connector.basic.TransferTransportListener<?> listener) {
            super(path, listener);
        }
    ...
    class GetTaskRunner
            extends TaskRunner
            implements RemoteAccessChecker, ChecksumValidator.ChecksumFetcher {
        ...
        GetTaskRunner(URI path, File file, ChecksumPolicy checksumPolicy,
                      List<RepositoryLayout.Checksum> checksums, org.eclipse.aether.connector.basic.TransferTransportListener<?> listener) {
            super(path, listener);
        ...
        protected void runTask()
            ...
            try {
                ...
                for (int firstTrial = 0, lastTrial = 1, trial = firstTrial; ; trial++) {
                    ...
                    try {
                        checksumValidator.validate(listener.getChecksums(), smartChecksums ? task.getChecksums() : null);
                        break;
